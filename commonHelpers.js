import{a as f,l as i,d as v,o as x}from"./assets/scroll_to_top-83e2a8e3.js";import{a as u,i as h}from"./assets/vendor-8cce9181.js";const y=document.querySelector(".favheader__button"),S=document.querySelector(".favmodal__button_close"),_=document.querySelector(".favmodal");y.addEventListener("click",()=>{_.showModal()});S.addEventListener("click",()=>{_.close()});const c={quoteText:document.querySelector(".favorites-text"),quoteAuthor:document.querySelector(".favorites-sub-title")},b="https://energyflow.b.goit.study/api/quote";async function E(e){try{f(i);const t=localStorage.getItem("quoteLocalData");if(t){const o=JSON.parse(t),m=n();if(o.date===m){d(o.author,o.quote);return}}const a=(await u.get(e)).data;if(a){const o={quote:a.quote,author:a.author,date:n()};localStorage.setItem("quoteLocalData",JSON.stringify(o)),d(o.author,o.quote)}}catch(t){h.error("Failed to fetch quote data"),console.error(t)}finally{v(i)}}function n(){const e=new Date,t=String(e.getDate()).padStart(2,"0"),s=String(e.getMonth()+1).padStart(2,"0"),a=e.getFullYear();return`${t}-${s}-${a}`}function d(e,t){c.quoteAuthor.textContent=e,c.quoteText.textContent=t}E(b);const q="https://energyflow.b.goit.study/api/exercises/",p=document.querySelector(".workouts-list");function k(e){return u.get(`${q}/${e}`)}let r=!0;const l=JSON.parse(localStorage.getItem("ENERGY_FLOW_FAVORITES_KEY"))||[];l.length>0?l.forEach(e=>{k(e).then(t=>{const s=t.data;L(s)}).catch(t=>{console.error(t)})}):(r=!1,g());function L(e){const t=w(e);p.insertAdjacentHTML("beforeend",t),I(e),document.querySelectorAll(".exercises_start").forEach(s=>s.addEventListener("click",x))}function I(e){document.querySelectorAll(".workout-card__remove-btn").forEach(s=>{s.getAttribute("data-workout-id")===e._id&&s.addEventListener("click",()=>{$(s,e._id)})})}function $(e,t){e.closest(".exercises_item").remove();const a=(JSON.parse(localStorage.getItem("ENERGY_FLOW_FAVORITES_KEY"))||[]).filter(o=>o!==t);localStorage.setItem("ENERGY_FLOW_FAVORITES_KEY",JSON.stringify(a)),localStorage.removeItem("workoutId"),a.length===0&&(r=!1),a.length===0&&g()}function w(e){return`
