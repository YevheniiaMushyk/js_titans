import{a as z,i as b}from"./vendor-8cce9181.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const ge=document.getElementById("loader");function fe(e){e.style.display="block"}function _e(e){e.style.display="none"}const m="/js_titans/assets/icons-2ff509a7.svg",q="ENERGY_FLOW_FAVORITES_KEY";function f(){const e=window.localStorage.getItem(q);return e&&e!=="undefined"?JSON.parse(e):[]}function G(e){const t=f(),n=t.length?[...t,e]:[e];window.localStorage.setItem(q,JSON.stringify(n))}function F(e){return!!f().find(n=>n._id===e)}function T(e){const n=f().filter(i=>i._id!==e);window.localStorage.setItem(q,JSON.stringify(n))}const s=document.getElementById("modal");s.querySelector(".modal-content");const Q=s.querySelector(".close"),w=s.querySelector(".exercise-gif"),A=s.querySelector(".exercise-title");s.querySelectorAll(".exercise-star");const M=s.querySelector(".exercise-target"),O=s.querySelector(".exercise-bodyparts"),P=s.querySelector(".exercise-equipment"),R=s.querySelector(".exercise-popular"),B=s.querySelector(".exercise-calories"),U=s.querySelector(".exercise-description"),N=s.querySelector(".favorite-button");document.querySelector(".rating-button");const W=document.querySelector(".rating-number");document.querySelector(".modal_rating");function ye(e){const t=e.target.closest(".exercises-item");if(!t)return;const n=Z(t);j(n),s.style.display="block"}function X(e){const t=e.target.closest(".exercises_item");if(!t)return;const n=D(t);j(n),s.style.display="block"}Q.addEventListener("click",()=>{s.style.display="none"});window.addEventListener("click",e=>{e.target===s&&(s.style.display="none")});window.addEventListener("keydown",e=>{e.key==="Escape"&&(s.style.display="none")});function I(e){const n=F(e)?"Remove from":"Add to favorites";N.innerHTML=`${n}
  ...
  `}function ie(e){document.querySelectorAll(".workout-card__remove-btn").forEach(n=>{n.getAttribute("data-workout-id")===e._id&&n.addEventListener("click",()=>{ae(n,e._id)})})}function ae(e,t){e.closest(".exercises_item").remove(),T(t),updatedStoredWorkouts.length===0&&V()}function V(){u.innerHTML=`
