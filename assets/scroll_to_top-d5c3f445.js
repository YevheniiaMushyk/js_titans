import{a as z,i as S}from"./vendor-8cce9181.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const ge=document.getElementById("loader");function fe(e){e.style.display="block"}function _e(e){e.style.display="none"}const p="/js_titans/assets/icons-2ff509a7.svg",q="ENERGY_FLOW_FAVORITES_KEY";function u(){const e=window.localStorage.getItem(q);return e&&e!=="undefined"?JSON.parse(e):[]}function G(e){const t=u(),n=t.length?[...t,e]:[e];window.localStorage.setItem(q,JSON.stringify(n))}function F(e){return!!u().find(n=>n._id===e)}function T(e){const n=u().filter(i=>i._id!==e);window.localStorage.setItem(q,JSON.stringify(n))}const s=document.getElementById("modal");s.querySelector(".modal-content");const Q=s.querySelector(".close"),w=s.querySelector(".exercise-gif"),A=s.querySelector(".exercise-title");s.querySelectorAll(".exercise-star");const M=s.querySelector(".exercise-target"),O=s.querySelector(".exercise-bodyparts"),P=s.querySelector(".exercise-equipment"),R=s.querySelector(".exercise-popular"),B=s.querySelector(".exercise-calories"),U=s.querySelector(".exercise-description"),N=s.querySelector(".favorite-button");document.querySelector(".rating-button");const W=document.querySelector(".rating-number");document.querySelector(".modal_rating");function ye(e){const t=e.target.closest(".exercises-item");if(!t)return;const n=Z(t);j(n),s.style.display="block"}function X(e){const t=e.target.closest(".exercises_item");if(!t)return;const n=D(t);j(n),s.style.display="block"}Q.addEventListener("click",()=>{s.style.display="none"});window.addEventListener("click",e=>{e.target===s&&(s.style.display="none")});window.addEventListener("keydown",e=>{e.key==="Escape"&&(s.style.display="none")});function I(e){const n=F(e)?"Remove from":"Add to favorites";N.innerHTML=`${n}
      ...
      <div class="exercises_sub_title">
        <div class="exercises__workout_rating">
          ...
          <button class="workout-card__remove-btn" data-workout-id="${e._id}">
            <svg class="workout-card__icon" width="16" height="16"><use href=${p}#icon-trash></use></svg>
          </button>
        </div>
  ...
  <div class="exercises_start">  
    ...
    ><use href=${p}#icon-arrow></use></svg>    
      ...
      <div class="exercises_title">
        <svg class="exercises_title__svg" width="24" height="24"><use href=${p}#icon-fav_run_man></use></svg>
  ...
  `}function ie(e){document.querySelectorAll(".workout-card__remove-btn").forEach(n=>{n.getAttribute("data-workout-id")===e._id&&n.addEventListener("click",()=>{ae(n,e._id)})})}function ae(e,t){e.closest(".exercises_item").remove(),T(t),u().length<1&&V()}function V(){console.log("EmptyMessage"),m.innerHTML=`
    ...
    </div>`}const ce=document.getElementById("modal_rating"),_=document.getElementById("modal"),le=document.querySelector(".modal_rating_close"),d=document.querySelector(".modal_rating_window"),$=document.querySelectorAll(".fa-solid"),l=document.querySelector(".modal_rating_digit"),y=document.querySelector(".modal_rating_form");let a=0,Y="",K="",g=0,k="";ce.addEventListener("click",()=>{a=0,l.textContent=`${a}.0`,_.classList.add("disactive_video_window"),d.showModal()});le.addEventListener("click",()=>{a=0,l.textContent=`${a}.0`,y.reset(),d.close(),_.classList.remove("disactive_video_window")});d.addEventListener("click",e=>{e.target===e.currentTarget&&(a=0,l.textContent=`${a}.0`,y.reset(),d.close(),_.classList.remove("disactive_video_window"))});const de=()=>{l.textContent=`${a}.0`};for(let e=0;e<$.length;e++){const t=$[e];t.addEventListener("mouseenter",()=>{const n=t.dataset.rating;l.textContent=`${n}.0`}),t.addEventListener("mouseleave",de),t.addEventListener("click",()=>{g=t.dataset.rating,a=g,l.textContent=`${g}.0`})}y.addEventListener("submit",ue);function ue(e){e.preventDefault();const t=e.currentTarget;Y=t.elements.email.value,K=t.elements.coment.value,a===0?S.error({message:"Please enter your raiting",position:"topCenter",backgroundColor:"#FF6666"}):me().then(()=>{d.close(),_.classList.remove("disactive_video_window"),S.info({message:"Thank you for your feedback",position:"topCenter"})}).catch(()=>{S.error({message:"Something wrong. Please try again later!",position:"topCenter"})}).finally(()=>{a=0,l.textContent=`${a}.0`,y.reset()})}function me(){let e={};e.rate=parseInt(g),e.email=Y,e.review=K,k=s.dataset.id;const t={method:"PATCH",body:JSON.stringify(e),headers:{"Content-Type":"application/json; charset=UTF-8"}};return fetch(`https://energyflow.b.goit.study/api/exercises/${k}/rating`,t).then(n=>{if(!n.ok)throw new Error(n.status);return n.json()})}let f=document.getElementById("toTop");f.style.display="none";window.addEventListener("scroll",()=>{window.scrollY>100?f.style.display="block":f.style.display="none"});f.onclick=function(){window.scrollTo({top:0,behavior:"smooth"})};export{fe as a,_e as d,p as e,ge as l,ye as o};
//# sourceMappingURL=scroll_to_top-d5c3f445.js.map
